...
import { ShieldCheck, Users, HeartHandshake, ArrowRight, ArrowDownRight, Compass, MessageSquareCode, CheckCircle2 } from 'lucide-react';
    ...
    <section id="hero-section" className="pt-8 pb-16 md:pt-14 md:pb-24 border-b border-stone-200/80">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl">
          <p className="text-stone-600 font-mono text-sm tracking-wide mb-2 font-medium">
            [{authorInfo.name}]
          </p>
